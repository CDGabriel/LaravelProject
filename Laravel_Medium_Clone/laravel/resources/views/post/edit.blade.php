                ...
                <form action="{{ route('post.update', $post->id) }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" autofocus
                            :value="old('image',$post->title)" autocomplete="username"></x-text-input>
                    ...
                    <div class="mt-2">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="published_at" class="block mt-1 w-full" type="datetime-local"
                                name="published_at" autofocus :value="old('published_at',$post->published_at)"
                                autocomplete="username"></x-text-input>
