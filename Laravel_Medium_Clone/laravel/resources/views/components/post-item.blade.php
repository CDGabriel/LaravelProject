<div class="bg-neutral-primary-soft border border-default rounded-base shadow-xs flex mb-8">
    ...
    'post' => $post
        ...
        <div class="mb-6 text-body">{{$post->content}}</div>
        <a href="{{ route('post.show', [
    'username' => $post->user->username,
    'post' => $post
]) }}" class="inline-flex items-center text-body border font-medium leading-5 rounded-base text-sm px-4 py-2.5 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white">
            Read more
        ...
        <div class="flex gap-4 py-3 items-center text-gray-500 text-sm">
