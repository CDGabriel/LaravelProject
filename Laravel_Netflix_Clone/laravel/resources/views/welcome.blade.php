...
<body class="min-h-screen overflow-x-hidden bg-[#0a0a0a] text-white">
    <header class="absolute top-0 left-0 z-50 w-full">
        @if (Route::has('login'))
            <nav class="absolute inset-x-0 top-0 flex items-center justify-between px-4 md:px-8 lg:px-12">
                <!-- Logo -->
                <div class="lg:px-56 shrink-0">
                    <img src="{{ asset('Images/LaraflixIcon2.png') }}" alt="Laraflix" class="w-40 h-40">
                </div>
                <!-- Navigation Buttons -->
                <div class="flex gap-4 lg:px-56">
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="inline-block text-center px-5 py-1.5 dark:text-[#EDEDEC] text-[#1b1b18] border border-transparent hover:border-[#19140035] dark:hover:border-white rounded-md text-sm leading-normal bg-red-600">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] text-[#1b1b18] border border-transparent hover:border-[#19140035] dark:hover:border-white rounded-md text-sm leading-normal bg-red-600">
                                Register
                            </a>
                        @endif
                    @endauth
    ...
    <main>
        ...
        <!-- Hero -->
        <div class="relative w-full h-screen overflow-hidden rounded-b-[]">
            <img src="{{ asset('Images/Hero.png') }}" alt="Background Image" class="w-full h-full object-cover" />
           ...
           to-black
           p-[7px]">
                    <div class="w-full h-full rounded-t-[100%] dark:bg-[#0a0a0a]">
                    </div>
                </div>
            </div>
            <div class="absolute inset-0 flex flex-col items-center justify-center gap-5">
                ...
                <p class="text-xl text-white">
                    Ready to watch? Register now to see what's trending.
                </p>
            </div>
        </div>
        ...
        <!-- Card Carousel -->
        <x-card-carousel :movies="$popular" title="Trending Now" category="popular"></x-card-carousel>

        <!-- Modal -->
        <x-modal-carousel category="popular"
            playHref="{{ auth()->check() && auth()->user()->hasVerifiedEmail() ? route('dashboard') : route('register') }}"
            buttonId="homeButton"></x-modal-carousel>


        <!-- Cards -->
        <div class="md:px-12 lg:px-32">
            <h1 class="font-bold text-2xl pb-4 md:px-10">More Reasons To Join</h1>
            <div class="flex flex-col gap-4 justify-center md:grid md:grid-cols-2 lg:flex lg:flex-row">
                <div
                    class="block lg:max-w-sm p-6 rounded-md shadow-xs hover:bg-neutral-secondary-medium bg-gradient-to-tl from-[#7A2F2F] to-[#7A542F]">
                    <h5 class="mb-3 text-2xl font-semibold tracking-tight text-heading leading-8">Enjoy on your TV</h5>
                    <p class="text-body">Watch on Smart TVs, Playstation, Xbox, Chromecast, Apple TV, Blu-ray players,
                        and more.</p>
                </div>
                <div
                    class="bg-gradient-to-tl from-[#7A2F2F] to-[#7A542F] block lg:max-w-sm p-6 rounded-base rounded-md shadow-xs hover:bg-neutral-secondary-medium">
                    <h5 class="mb-3 text-2xl font-semibold tracking-tight text-heading leading-8">Watch for free</h5>
                    <p class="text-body">You can watch your favourite films for free! All you have to do is sign up.</p>
                </div>
                <div
                    class="bg-gradient-to-tl from-[#7A2F2F] to-[#7A542F] block lg:max-w-sm p-6 rounded-base rounded-md shadow-xs hover:bg-neutral-secondary-medium">
                    <h5 class="mb-3 text-2xl font-semibold tracking-tight text-heading leading-8">Watch everywhere</h5>
                    <p class="text-body">Watch unlimited movies and TV shows on your phone, tablet, laptop, and TV.</p>
                </div>
                <div
                    class="bg-gradient-to-tl from-[#7A2F2F] to-[#7A542F] block lg:max-w-sm p-6 rounded-base rounded-md shadow-xs hover:bg-neutral-secondary-medium">
                    <h5 class="mb-3 text-2xl font-semibold tracking-tight text-heading leading-8">Download your shows to
                        watch offline</h5>
                    <p class="text-body">Save your favorites easily and always have something to watch.</p>
                </div>
            </div>
        </div>

        <!-- Accordion -->
        <div class="lg:px-32 m-10 text-white mt-36">
            <h1 class="font-bold text-2xl">Frequently Asked Questions</h1>

            <!-- Accordion Item 1 -->
            <div class="border-b border-slate-200">
                <button onclick="toggleAccordion(1)" class="w-full flex justify-between items-center py-5 ">
                    <span>What is Laraflix?</span>
                ...
                <div id="content-1" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div class="pb-5 text-sm">
                        Laraflix is a streaming service that offers a wide variety of award-winning TV shows, movies,
                        anime, documentaries, and more on thousands of internet-connected devices.

                        You can watch as much as you want, whenever you want without a single commercial. There's always
            ...
            <!-- Accordion Item 2 -->
            <div class="border-b border-slate-200">
                <button onclick="toggleAccordion(2)" class="w-full flex justify-between items-center py-5 ">
                    <span>How much does Laraflix Cost?</span>
                ...
                <div id="content-2" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div class="pb-5 text-sm">
                        There is no cost to using Laraflix! Every film and serie is free.
                    </div>
                </div>
            </div>
            ...
            <!-- Accordion Item 3 -->
            <div class="border-b border-slate-200">
                <button onclick="toggleAccordion(3)" class="w-full flex justify-between items-center py-5 ">
                ...
                <div id="content-3" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div class="pb-5 text-sm">
                        Watch anywhere, anytime. Sign in with your Laraflix account to watch instantly on the web from
            ...
            <!-- Accordion Item 4 -->
            <div class="border-b border-slate-200">
                <button onclick="toggleAccordion(4)" class="w-full flex justify-between items-center py-5 ">
                    <span>What can I watch on Laraflix?</span>
                ...
                <div id="content-4" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                    <div class="pb-5 text-sm">
                        Laraflix has an extensive library of feature films, documentaries, TV shows, anime,
